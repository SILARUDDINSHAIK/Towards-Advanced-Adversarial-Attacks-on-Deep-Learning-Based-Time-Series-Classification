...
import pandas as pd
import json
base_dir = "/Users/silaruddin/Desktop/time-series-adversarials/Results"
results = []
...
pd.DataFrame.from_records(results).to_csv("timeseriesPGDresnet.csv")
